...
<link rel="stylesheet" href="/public/css/style_golfbusiness.css">
<!-- Resource style -->
<script src="/public/js/modernizr_golfbusiness.js"></script>
<!-- Modernizr -->
                    ...
                    <div class="container">
                        <div class="form-wrapper">
                            ...
                            <div class="row cf">
                                ...
                                <input class="text-input" type="text" name="email" id="text1">
                            </div>
                            <div class="row cf">
                                <span>Your phone:</span>
                                <input class="text-input" type="text" name="manager_phone" id="text1">
                            </div>
                            <div class="row cf">
...
<script src="/public/js/golfbusiness_main.js"></script>
<!-- Resource jQuery -->
