                ...
                <div class="portfolio_container">
                    <div class="portfolio">
                        <div class="portfolio-title">
                            GolfBusiness<br> 골프비즈니스
                            <br>
                        </div>
                        <div class="portfolio-content">
                            해외 골프장 업계 현황 데이터 및 M&A물건 정보 및 컨섩팅
                        </div>
                        <div style="background-image: url(/public/images/submit.png); background-repeat: no-repeat; width: 437px; height: 100px; margin-top: 70px;">
